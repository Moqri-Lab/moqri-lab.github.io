...
const PEOPLE = [
...

  {
    ...
    bio: "Dr. Reyhaneh (Rey) Zafarnejad is a health economics and computational health science researcher at Brigham and Women’s Hospital, with expertise in decision science, real-world evidence, AI/ML, and healthcare data analytics. Her research focuses on using patient- and population-level data, together with emerging biomarkers, to identify high-risk individuals earlier and evaluate strategies for prevention, screening, and care delivery. Her prior work includes decision-analytic modeling for aging-related conditions and EHR-based early detection methods using longitudinal health markers. Her work aims to translate data-driven evidence into actionable, policy-relevant, and cost-effective healthcare strategies. Dr. Zafarnejad’s formal training is in systems engineering and health informatics, and she completed her postdoctoral fellowship training at Harvard Medical School.",
    links: {
